...
mode_coeffs = field2modes(nothing, coords, modes,diskR=diskR)
field = modes2field(mode_coeffs, coords, modes)
@test field[5000] ≈ 0.03647557026951998 + 0.0im

propmat = calc_propagation_matrices(sbdry, coords, modes)
@test propmat[1][4,6] ≈ 0.00021462613718063045 + 0.0im

println("Finished testing for TRANSFORMER")
#--------------------------------------------------------------------------------------------
@test boost_factor_cheerleader ≈ [0.9541048836881387, 4.182537182036321, 18.70293960502623, 7.465918522414759, 10.764938064402624, 15.415614620919474, 1.2667394643264536, 1.9715312870420645, 27.119751483329694, 8.413847982210477]
...
@test boost_factor_dancer ≈ [1.003029819130254, 5.497534861256151, 19.03228878235599, 7.817723902385752, 12.610984927623164, 14.178962970482115, 1.1434594478152733, 2.4841683203606983, 31.00826150988098, 8.548916138820806]
...
@test boost_factor_transformer ≈ [0.9219455134201273, 4.047480657662905, 18.261152610706294, 7.2468392586506525, 10.476628877197278, 15.022228781938008, 1.1827220364110227, 1.917381440805424, 26.539784031486857, 8.127709799564798]
